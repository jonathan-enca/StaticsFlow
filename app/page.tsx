    ...
    <nav className="sticky top-0 z-50 bg-white/95 backdrop-blur border-b border-gray-100">
      ...
      {menuOpen && (
        <div className="md:hidden bg-white border-t border-gray-100 px-6 py-4 flex flex-col gap-4">
          ...
          <a href="/onboarding" className="text-sm font-semibold text-white bg-black px-4 py-2.5 rounded-lg text-center hover:bg-gray-800 transition-colors">
            Get started free
          </a>
        </div>
      )}
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-5">
              <a
                href="/onboarding"
                className="inline-flex items-center justify-center px-7 py-3.5 bg-black text-white text-base font-semibold rounded-xl hover:bg-gray-800 transition-colors"
              >
                Start for free →
              </a>
              <a
                href="#how-it-works"
                className="inline-flex items-center justify-center px-7 py-3.5 border border-gray-200 text-gray-700 text-base font-medium rounded-xl hover:bg-gray-50 transition-colors"
              >
                See how it works
              </a>
            </div>
            ...
            <div className="relative">
              ...
              <div className="bg-white rounded-2xl border border-gray-200 shadow-2xl overflow-hidden">
                ...
                <div className="bg-gray-50 border-b border-gray-200 px-4 py-3 flex items-center gap-3">
                  ...
                  <div className="flex-1 bg-white rounded-md px-3 py-1.5 text-xs text-gray-400 border border-gray-200 text-center">
                ...
                <div className="p-6 bg-white">
                  ...
                  <div className="flex gap-2 mb-4">
                    ...
                    <div className="w-8 h-8 rounded-lg bg-amber-50 border border-gray-200"></div>
                    <div className="w-8 h-8 rounded-lg bg-amber-600"></div>
                    <div className="w-8 h-8 rounded-lg bg-stone-400"></div>
                  ...
                  {/* Creative preview */}
                  <div className="mt-4 rounded-xl bg-gray-900 p-4 text-white aspect-square max-w-[180px]">
                    ...
                    <div className="mt-3 text-xs text-amber-400 font-medium">Shop the collection →</div>
                  </div>
                </div>
              </div>
              {/* Decorative gradient blob */}
              <div className="absolute -top-6 -right-6 w-32 h-32 bg-purple-100 rounded-full blur-3xl opacity-60 -z-10"></div>
              <div className="absolute -bottom-6 -left-6 w-24 h-24 bg-blue-100 rounded-full blur-3xl opacity-60 -z-10"></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="how-it-works" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {steps.map((step) => (
            <div key={step.num} className="bg-white rounded-2xl border border-gray-100 p-8">
...
function Features() {
  ...
  return (
    <section id="features" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <h2 className="text-3xl font-bold text-center text-gray-900 mb-4">Why StaticsFlow</h2>
        <p className="text-gray-500 text-center mb-12">Built for media buyers who refuse generic creatives.</p>
        <div className="grid md:grid-cols-2 gap-6">
          {features.map((f) => (
            <div key={f.title} className="p-8 rounded-2xl bg-white border border-gray-100 hover:border-gray-200 transition-colors">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          {plans.map((plan) => (
            ...
            >
              {plan.badge && (
                <div className="inline-flex self-start mb-4 px-3 py-1 bg-black text-white text-xs font-semibold rounded-full">
                  {plan.badge}
                </div>
              )}
              ...
              <a
                href="/onboarding"
                className={`text-center px-6 py-3 rounded-xl text-sm font-semibold transition-colors ${
                  plan.highlighted
  ...
  return (
    <section className="py-20 bg-gray-900">
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <a
          href="/onboarding"
          className="inline-flex items-center px-8 py-3.5 bg-white text-gray-900 font-semibold rounded-xl hover:bg-gray-100 transition-colors text-base"
        >
          Start for free →
        </a>
      </div>
